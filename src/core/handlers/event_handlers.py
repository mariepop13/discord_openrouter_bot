import discord
from src.commands.ai.ai_chat import ai_command
from src.utils.logging.logging_utils import get_logger
from src.database.schema.database_init import initialize_database
from src.core.handlers.sync_commands import force_sync
